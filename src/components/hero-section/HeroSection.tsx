...
const HeroSection = () => {
    return (
        <section className="min-h-[80vh] text-center flex items-center justify-center flex-col mb-16">
            ...
            <p className="mb-1 sm:mb-4 text-lg font-normal text-gray-600 lg:text-xl sm:px-16 xl:px-48">
                Hi! my name is Shaukat Ali. I am a full-stack developer
                specializing in creating dynamic applications using React.js and
                the MERN stack.
            </p>
            <p className="mb-4 sm:mb-8 text-lg font-normal text-gray-600 lg:text-xl sm:px-16 xl:px-48">
